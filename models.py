...
class GTransNet(nn.Module):
    def __init__(self, hidden_dim=600, output_dim=500, gamma=2):
        ...
        a = torch.sqrt(torch.tensor(0.5) / (hidden_dim))
    ...
    def derivative(self, u, order=1):
        ...
        u2_x, u2_y = u1_x @ self.fc2.weight.T, u1_y @ self.fc2.weight.T
        ...
        if order == 2:
            ...
            u2_xx, u2_yy, u2_xy = u1_xx @ self.fc2.weight.T, u1_yy @ self.fc2.weight.T, u1_xy @ self.fc2.weight.T
